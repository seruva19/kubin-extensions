...
(https://github.com/ai-forever/KandinskyVideo/blob/main/video_kandinsky3/model/utils.py)
"""
...
def set_default_layer(
    condition, layer_1, args_1=[], kwargs_1={}, layer_2=Identity, args_2=[], kwargs_2={}
):
    if condition:
