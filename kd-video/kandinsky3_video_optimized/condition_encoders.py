...
(https://github.com/ai-forever/KandinskyVideo/blob/main/video_kandinsky3/condition_encoders.py)
"""
...
from transformers import CLIPModel, T5EncoderModel, BitsAndBytesConfig
from typing import Optional
...
class T5TextConditionEncoder(ConditionEncoder):
    def __init__(
        ...
        self.encoders = nn.ModuleDict({"t5": t5_model.encoder})
